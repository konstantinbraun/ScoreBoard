...
using System.IO;
using IdentitySample.Properties;
...
namespace IdentitySample.Models
{
    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        //public EmailService() {
        //    templates.Add(new EmailTemplate() { EmailType = EmailType.ParticipateTournamentRequest, MailMessage = ParicipateInTournamentRequest });
        //    templates.Add(new EmailTemplate() { EmailType = EmailType.ParticipateTournamentReply, MailMessage = ParicipateInTournamentRequest });
        //}
        ...
        public Task SendAsync(IdentityMessage message)
        {
          ...
          ////  EmailTemplate template = templates.Where(x => x.EmailType == EmailType).Single();
          //   oSmtpClient.Send(new MailMessage(message.Destination, message.Destination, message.Subject, message.Body));
...
//                templateBody = templateBody.Replace("@TextBody", sBody)
            ...
            mailMessage.To.Add(new MailAddress(message.Destination, "Test"));
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext> 
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db) {
            ...
            const string name = "konstantin.braun@outlook.com";
            const string password = "kotikus12";
            ...
            if (user == null) {
                user = new ApplicationUser { UserName = name, Email = name, FirstName ="Konstantin", LastName = "Braun", EmailConfirmed =true };
